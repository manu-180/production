 ...
 * route handlers. This proxy exists as a hook for future auth gates
 * and is intentionally near-empty.
 *
 * Renamed from middleware -> proxy in Next.js 16. Functionality identical.
 *
